...
class LoginAlumni extends StatefulWidget {
  const LoginAlumni({super.key});

  @override
  State<LoginAlumni> createState() => _LoginAlumniState();
}
...
class _LoginAlumniState extends State<LoginAlumni> {
                          ...
                          onTap: () {
                            setState(() {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => NavigationAlumni(),
                                ),
                              );
                            });
                          },
